...
class Normalization:
    ...
    @staticmethod
    def decide_norm(norm="batch_norm"):
        norm_func = None
        if (norm == "batch_norm"):
            norm_func = BatchNormalization()
        elif (norm == "layer_norm"):
            norm_func = LayerNormalization()
        elif (norm == "batch_renorm"):
            norm_func = BatchNormalization(renorm=True)
        elif (norm == "batch_instance_norm"):
            norm_func = BatchInstanceNormalization()
        elif (norm == "group_norm"):
            norm_func = GroupNormalization()
