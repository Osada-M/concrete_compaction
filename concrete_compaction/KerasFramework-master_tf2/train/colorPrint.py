...
class Cprint:
    ...
    def colored(string:str="", color:str=None, background:str=None, bloom:str=None):
        ...
        if (color == "random"):
            color = f"{int(hex(random.randint(0, 255))[2:],16):02d}{int(hex(random.randint(0, 255))[2:],16):02d}{int(hex(random.randint(0, 255))[2:],16):02d}"
        if (background == "random"):
            background = f"{int(hex(random.randint(0, 255))[2:],16):02d}{int(hex(random.randint(0, 255))[2:],16):02d}{int(hex(random.randint(0, 255))[2:],16):02d}"
